...
def imparList(lista):
    ...
    for i in range(len(lista)):
        if lista[i]%2 != 0:
            lisimpar.append(lista[i])    
    return lisimpar
        
lista = [0, 1, 7, 4, 5]
print(lista)
print(imparList(lista))
...
print('Há', numpalavras, 'palavras, >=5 na string.')
